...
def fdipolo_network():
    ...
    pp.create_load(net, bus=pp.get_element_index(net, "bus", "00102000722A1"), p_mw=0.050, q_mvar=0, name="Fontana_di_polo_1", scaling=1.0, in_service=True, type='wye')
    pp.create_load(net, bus=pp.get_element_index(net, "bus", "00102000722A1"), p_mw=0.050, q_mvar=0, name="Fontana_di_polo_2", scaling=1.0, in_service=True, type='wye')
    ...
    pp.create_load(net, bus=pp.get_element_index(net, "bus", "00102000725A1"), p_mw=0.050, q_mvar=0, name="Tre_T_1", scaling=1.0, in_service=True, type='wye')
    pp.create_load(net, bus=pp.get_element_index(net, "bus", "00102000725A1"), p_mw=0.050, q_mvar=0, name="Tre_T_2", scaling=1.0, in_service=True, type='wye')
    ...
    pp.create_load(net, bus=pp.get_element_index(net, "bus", "00102000764A1"), p_mw=0.050, q_mvar=0, name="Archimede", scaling=1.0, in_service=True, type='wye')
