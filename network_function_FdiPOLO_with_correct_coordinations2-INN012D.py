...
def fdipolo_network():
    ...
    # create loads
    pp.create_load(net, bus=pp.get_element_index(net, "bus", "00102000459A1"), p_mw=0.050, q_mvar=0, name="Siemens_1", scaling=1.0, in_service=True, type='wye')
    pp.create_load(net, bus=pp.get_element_index(net, "bus", "00102000459A1"), p_mw=0.050, q_mvar=0, name="Siemens_2", scaling=1.0, in_service=True, type='wye')

    pp.create_load(net, bus=pp.get_element_index(net, "bus", "00102000722A1"), p_mw=0.050, q_mvar=0, name="Fontana_di_polo", scaling=1.0, in_service=True, type='wye')
    pp.create_load(net, bus=pp.get_element_index(net, "bus", "00102000723A1"), p_mw=0.050, q_mvar=0, name="Aviosuperficie", scaling=1.0, in_service=True, type='wye')
    pp.create_load(net, bus=pp.get_element_index(net, "bus", "00102000725A1"), p_mw=0.050, q_mvar=0, name="Tre_T", scaling=1.0, in_service=True, type='wye')
    pp.create_load(net, bus=pp.get_element_index(net, "bus", "00102000827A1"), p_mw=0.050, q_mvar=0, name="Angelini", scaling=1.0, in_service=True, type='wye')
    pp.create_load(net, bus=pp.get_element_index(net, "bus", "00102000724A1"), p_mw=0.050, q_mvar=0, name="Tecnomultiservice", scaling=1.0, in_service=True, type='wye')
    pp.create_load(net, bus=pp.get_element_index(net, "bus", "00102000764A1"), p_mw=0.050, q_mvar=0, name="Archimede_1", scaling=1.0, in_service=True, type='wye')
    pp.create_load(net, bus=pp.get_element_index(net, "bus", "00102000764A1"), p_mw=0.050, q_mvar=0, name="Archimede_2", scaling=1.0, in_service=True, type='wye')
    pp.create_load(net, bus=pp.get_element_index(net, "bus", "00102000764A1"), p_mw=0.050, q_mvar=0, name="Archimede_3", scaling=1.0, in_service=True, type='wye')
    pp.create_load(net, bus=pp.get_element_index(net, "bus", "00102000764A1"), p_mw=0.050, q_mvar=0, name="Archimede_4", scaling=1.0, in_service=True, type='wye')
